...
If a shell design has been created for this project (check if `/src/shell/components/ShellWrapper.{tsx|svelte|astro}` or legacy `/src/shell/components/AppShell.{tsx|svelte|astro}` exists), ask the user about shell usage:
